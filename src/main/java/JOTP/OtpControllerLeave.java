...
public class OtpControllerLeave extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 바코드 주소 생성
		// 바코드 url을 만드는 메소드인 getQRBarcodeURL에서 user와 host값은 다른 암호와 구분하기위한 값으로 아무값이나 넣어도
		// 됨.
		...
		req.getRequestDispatcher("/otp/OtpLeavePage.jsp").forward(req, resp);
	}
