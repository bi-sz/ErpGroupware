		   ...
		   <form action="<%=request.getContextPath() %>/JOTP/OTPTestResult.ok" method="get">
		      ...
		      <table border="1" width="100%" class="login">
		      	<tr>
		            ...
		            <td>
		               <!--  -input type="text" class="form-control" name="id" value="<!--%=session.getAttribute("id")%>" readonly="readonly"/-->
		         ...
		         <tr >
		            ...
		            <td>
		               <input type="number" class="form-control" id="code" name="code" placeholder="코드를 입력해주세요" maxlength="9"/>
		            </td> 
		         </tr>
		      </table>
